...
1. If voice.md exists, was it read, and does the edit honor it where it conflicts with the general rules?
...
1. Are banned words removed unless quoted as examples?
2. Are watch words cut where they decorate or inflate, and kept only where they are the precise term or the writer's own vocabulary?
3. Are filler phrases, often-empty adverbs, and inflated claims removed unless they carry real emphasis or voice?

## Patterns to cut

1. Are empty binary contrasts, negative listings, rhetorical setups, and throat-clearing openers removed, with at most one contrast that corrects a belief the reader actually holds?
2. Are faux-insight setups, stacked colon reveals, superficial analysis, fake-strong verbs, synonym cycling, fragment stacking, and robotic rhythm fixed, while deliberate punch lines and single fragments the voice supports remain?
...
4. Are compressed verdicts unpacked into a plain claim plus its tradeoff instead of a clever label?
5. Is interpretive metadiscourse removed, including authorial metacommentary, reader guidance, emphasis markers, and redundant glossing?
...
8. Is formatting slop removed: Emoji headings, decorative bold, bullets that should be prose, headers over tiny sections? (Bold on the single key number or decision is allowed.)
